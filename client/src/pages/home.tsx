          ...
          <div className="grid lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 text-white animate-fade-in-up">
              <div className="max-w-2xl">
                ...
                <h1 className="font-black leading-[0.9] mb-8 text-shadow-xl">
                  <div className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl whitespace-nowrap" style={{ textShadow: '0 8px 16px rgba(0, 0, 0, 0.6)' }}>Digital partner åt</div>
                  <div className="text-orange-400 text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl whitespace-nowrap drop-shadow-2xl font-black" style={{ textShadow: '0 8px 16px rgba(0, 0, 0, 0.6), 0 4px 8px rgba(255, 140, 0, 0.3)' }}>småföretag</div>
                </h1>
                
                {/* Description */}
                <p className="text-xl sm:text-2xl text-white mb-10 leading-relaxed max-w-2xl font-medium text-shadow-xl" style={{ textShadow: '0 6px 12px rgba(0, 0, 0, 0.5)' }}>
